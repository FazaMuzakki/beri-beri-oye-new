/* ===========================================================
   Penilaian Lapangan – Replikasi Formulir Kondisi (tanpa Excel)
...

{
  ...
  function render() {
    ...
    for (var s = 0; s < FORM_CONFIG.length; s++) {
        ...
        var html = '<h2 class="form-title">' + esc(section.title) + '</h2>'; // Changed class here
...
function setupFileUpload() {
  ...
  function fieldHTML(f) {
    ...
    var html = '';
    var hasObservationField = true; // Add observation field by default for most question types
